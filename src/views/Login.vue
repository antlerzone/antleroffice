...
import { openExternalUrl, isElectronApp } from '@/lib/desktop-shell'
...
async function pollDesktopHandoff() {
  try {
    ...
    if (!res.ok || !data.ok || !data.pending) return false
    ...
    <div class="login-right">
      <div class="login-form-wrapper">
        ...
        <template v-else>
          ...
          <p v-if="isElectronApp()" class="login-hint">
            Google and Facebook open in your browser. After sign-in, return to this app — it will continue automatically.
          </p>
        </template>
      </div>
    </div>
